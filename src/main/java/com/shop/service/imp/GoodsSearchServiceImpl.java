...
public class GoodsSearchServiceImpl implements GoodsSearchService{
    ...
    public List<Good> searchGoodsBySubCategoryId(Integer subCategoryId,Integer page,Integer size){
        Integer offset=getOffset(page,size);
        List<Good> goods=goodsSearchDao.getGoodBySubCategoryId(subCategoryId,offset,size);
        return goods;
    }
